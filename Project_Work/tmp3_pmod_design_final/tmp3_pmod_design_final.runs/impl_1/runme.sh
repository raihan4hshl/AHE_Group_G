...
HD_PWD='C:/Users/User/Documents/GitHub/Hardware_vhdl_ip_files/tmp3_pmod_design_final/tmp3_pmod_design_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tmp3_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tmp3_system_wrapper.tcl -notrace
