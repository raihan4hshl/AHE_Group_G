...
HD_PWD='D:/Advanced_Hardware_Engineering/ALS_IP_Block/ALS_IP_Block.runs/MicroblazeWithALS_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroblazeWithALS_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroblazeWithALS_microblaze_0_0.tcl
