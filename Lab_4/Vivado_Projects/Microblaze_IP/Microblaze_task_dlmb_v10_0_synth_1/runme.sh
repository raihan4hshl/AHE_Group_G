...
HD_PWD='F:/Advanced_Hardware_Engineering/Vivado Projects/Microblaze_IP/Microblaze_task_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Microblaze_task_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Microblaze_task_dlmb_v10_0.tcl
