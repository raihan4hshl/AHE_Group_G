...
HD_PWD='C:/Users/Kashif/Desktop/WS2024/EMP 2/LAB/PROJECT/Microblaze_and_other_IPs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PMOD_IPs_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PMOD_IPs_wrapper.tcl
