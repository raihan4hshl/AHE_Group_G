...
#ifndef _MicroblazeWithALS_microblaze_0_xlconcat_0_core_h_
#define _MicroblazeWithALS_microblaze_0_xlconcat_0_core_h_
...
class MicroblazeWithALS_microblaze_0_xlconcat_0_core : public sc_module 
{
    public: 
       MicroblazeWithALS_microblaze_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(MicroblazeWithALS_microblaze_0_xlconcat_0_core);
        SC_METHOD(concate_input_port_values);
            sensitive << In0 ;
        dont_initialize();
    }

    virtual ~MicroblazeWithALS_microblaze_0_xlconcat_0_core() = default;
