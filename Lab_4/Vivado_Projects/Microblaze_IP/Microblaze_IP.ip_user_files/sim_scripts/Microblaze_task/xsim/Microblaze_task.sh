...
#
# Script generated by Vivado on Thu Nov 06 13:42:23 +0100 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Microblaze_task.sh
...
#
# Usage        : Microblaze_task.sh
#                Microblaze_task.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Microblaze_task.sh [-reset_run]
#                Microblaze_task.sh [-reset_log]
#                Microblaze_task.sh [-help]
#
...
# script info
echo -e "Microblaze_task.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Microblaze_task.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L microblaze_v11_0_15 -L lmb_v10_v3_0_15 -L lmb_bram_if_cntlr_v4_0_26 -L blk_mem_gen_v8_4_11 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_35 -L fifo_generator_v13_2_13 -L axi_data_fifo_v2_1_35 -L axi_crossbar_v2_1_37 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_21 -L xlconcat_v2_1_7 -L mdm_v3_2_28 -L proc_sys_reset_v5_0_17 -L axi_uartlite_v2_0_39 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Microblaze_task xil_defaultlib.Microblaze_task xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Microblaze_task -key {Behavioral:sim_1:Functional:Microblaze_task} -tclbatch cmd.tcl -protoinst "protoinst_files/Microblaze_task.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xpm microblaze_v11_0_15 lmb_v10_v3_0_15 lmb_bram_if_cntlr_v4_0_26 blk_mem_gen_v8_4_11 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_35 fifo_generator_v13_2_13 axi_data_fifo_v2_1_35 axi_crossbar_v2_1_37 axi_lite_ipif_v3_0_4 axi_intc_v4_1_21 xlconcat_v2_1_7 mdm_v3_2_28 proc_sys_reset_v5_0_17 axi_uartlite_v2_0_39)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Microblaze_task.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Microblaze_task.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Microblaze_task.sh [-help]\n\
Usage: Microblaze_task.sh [-step]\n\
Usage: Microblaze_task.sh [-lib_map_path]\n\
Usage: Microblaze_task.sh [-reset_run]\n\
Usage: Microblaze_task.sh [-reset_log]\n\
Usage: Microblaze_task.sh [-keep_index]\n\
Usage: Microblaze_task.sh [-noclean_files]\n\n\
