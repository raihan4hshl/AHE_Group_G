...
HD_PWD='D:/Advanced_Hardware_Engineering/ALS_IP_Block/MicroblazeWithALS_dlmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroblazeWithALS_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroblazeWithALS_dlmb_bram_if_cntlr_0.tcl
