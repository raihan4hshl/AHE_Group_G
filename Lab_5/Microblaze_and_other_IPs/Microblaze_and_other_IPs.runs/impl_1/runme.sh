...
HD_PWD='C:/Users/Kashif/Desktop/WS2024/EMP 2/LAB/PROJECT/Microblaze_and_other_IPs.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PMOD_IPs_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PMOD_IPs_wrapper.tcl -notrace
