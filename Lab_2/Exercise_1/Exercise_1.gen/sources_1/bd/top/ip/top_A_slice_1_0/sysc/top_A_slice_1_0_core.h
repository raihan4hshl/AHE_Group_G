...
#ifndef _top_A_slice_1_0_core_h_
#define _top_A_slice_1_0_core_h_

#include <systemc.h>
#include "properties.h"


class top_A_slice_1_0_core : public sc_module 
{
    public: 
       top_A_slice_1_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(top_A_slice_1_0_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~top_A_slice_1_0_core() = default;
