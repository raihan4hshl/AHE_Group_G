...
HD_PWD='D:/Advanced_Hardware_Engineering/Vivado_Projects/Microblaze_IP/Microblaze_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Microblaze_task_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Microblaze_task_wrapper.tcl
