...
HD_PWD='C:/Users/User/Documents/GitHub/Hardware_vhdl_ip_files/tmp3_pmod_design_final/tmp3_pmod_design_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tmp3_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tmp3_system_wrapper.tcl
