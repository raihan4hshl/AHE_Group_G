...
ISEStep( "vivado",
         "-log Microblaze_task_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Microblaze_task_dlmb_bram_if_cntlr_0.tcl" );
