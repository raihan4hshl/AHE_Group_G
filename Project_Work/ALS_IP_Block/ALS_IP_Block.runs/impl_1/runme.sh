...
HD_PWD='D:/Advanced_Hardware_Engineering/ALS_IP_Block/ALS_IP_Block.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroblazeWithALS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroblazeWithALS_wrapper.tcl -notrace
