...
#
# Script generated by Vivado on Tue Jan 13 13:24:12 +0100 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tmp3_system.sh
...
#
# Usage        : tmp3_system.sh
#                tmp3_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tmp3_system.sh [-reset_run]
#                tmp3_system.sh [-reset_log]
#                tmp3_system.sh [-help]
#
...
# script info
echo -e "tmp3_system.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tmp3_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tmp3_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tmp3_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tmp3_system.sh [-help]\n\
Usage: tmp3_system.sh [-step]\n\
Usage: tmp3_system.sh [-lib_map_path]\n\
Usage: tmp3_system.sh [-reset_run]\n\
Usage: tmp3_system.sh [-reset_log]\n\
Usage: tmp3_system.sh [-keep_index]\n\
Usage: tmp3_system.sh [-noclean_files]\n\n\
