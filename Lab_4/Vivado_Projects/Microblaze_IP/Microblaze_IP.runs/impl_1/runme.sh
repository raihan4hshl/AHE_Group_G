...
HD_PWD='D:/Advanced_Hardware_Engineering/Vivado_Projects/Microblaze_IP/Microblaze_IP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Microblaze_task_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Microblaze_task_wrapper.tcl -notrace
