...
#ifndef _Full_Adder_4_bit_xlslice_0_1_core_h_
#define _Full_Adder_4_bit_xlslice_0_1_core_h_

#include <systemc.h>
#include "properties.h"


class Full_Adder_4_bit_xlslice_0_1_core : public sc_module 
{
    public: 
       Full_Adder_4_bit_xlslice_0_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , Din    ( "Din" )
              , Dout   ( "Dout" )
    {
        SC_HAS_PROCESS(Full_Adder_4_bit_xlslice_0_1_core);
        SC_METHOD(get_slice_value);
        sensitive << Din;

    }

    virtual ~Full_Adder_4_bit_xlslice_0_1_core() = default;
